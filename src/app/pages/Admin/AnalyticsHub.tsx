...
export function AnalyticsHub() {
  ...
  const [activeTab, setActiveTab] = useState<'main' | 'integrity'>('main');
    ...
    const fetchAnalytics = async () => {
      try {
        ...
        if (activeTab === 'main') {
          ...
          const res = await fetchWithAuth(`/api/analytics/operational-integrity?timeframe=${tf}`);
          if (res && res.ok) {
  ...
  }, [timeframe, activeTab, fetchWithAuth]);
      ...
      <div className="max-w-[1400px] mx-auto space-y-4 print-container relative z-10">
        ...
        {activeTab === 'main' ? (
          <>
            ...
            {/* Vitals Section */}
            <div className="grid grid-cols-1 lg:grid-cols-4 gap-4 animate-in fade-in slide-in-from-top-2 duration-700">
            ...
            {/* Transaction Log */}
            <Card className="rounded-lg border-none shadow-sm overflow-hidden bg-white animate-in fade-in slide-in-from-bottom-2 duration-700 delay-150">
